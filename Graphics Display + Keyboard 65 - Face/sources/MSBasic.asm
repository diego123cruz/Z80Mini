...
ONJMP:  
		cp		ZBYE			; token lesser than zbuy
		jr		c,notcust		; if so skip to original code
		sub		ZBYE			; subtract zbye to index int custtab
		rlca					; multiply by tw to make offset
		ld		c,a
		ld		b,0
		ex		de,hl			; save code string addr
		ld		hl,custtab		; load tabel addr
		jr		custadd			; let the original code take over
