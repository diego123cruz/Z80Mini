...
;main.c:17: clearGBUF();
	call	_clearGBUF
;main.c:18: drawBox(0,0,127,63);
	ld	hl, #0x3f7f
	push	hl
	xor	a, a
	ld	l, a
	call	_drawBox
;main.c:19: setCursor(x, y);
	ld	a, (_y)
	ld	l, a
	ld	a, (_x)
	call	_setCursor
;main.c:20: sendStringToLCD("Z80Mini");
	ld	hl, #___str_0
...
;Z80Mini.c:282: __endasm;
	...
	ret
;Z80Mini.c:283: }
;Z80Mini.c:285: void drawLine(
;	---------------------------------
; Function drawLine
; ---------------------------------
_drawLine::
;Z80Mini.c:312: __endasm;
	ld	b, a
	ld	c, l
	ld	hl, #2
	add	hl, sp
	...
	ret
;Z80Mini.c:313: }
;Z80Mini.c:315: void fillBox(
;	---------------------------------
; Function fillBox
; ---------------------------------
_fillBox::
;Z80Mini.c:342: __endasm;
	ld	b, a
	ld	c, l
	ld	hl, #2
	add	hl, sp
	...
	ret
;Z80Mini.c:343: }
;Z80Mini.c:345: void drawCircle(
;	---------------------------------
; Function drawCircle
; ---------------------------------
_drawCircle::
;Z80Mini.c:368: __endasm;
	ld	b, a
	ld	c, l
	ld	hl, #2
	add	hl, sp
