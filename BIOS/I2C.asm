...
I2CLIST:    LD   HL, I2C_LIST_MSG        ;Address of message string
            ;XOR A ; A = character to stop printing.
...
I2C_MemRdReady:     POP  BC             ;Restore byte counter
            ...
            CALL I2C_Write      ;Write address
            LD   A, (I2CA_BLOCK) ;I2C device to be read from
            INC  A              ; Device read equal DeviceId+1
